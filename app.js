  ...
  [...filteredDatos].sort((a,b)=>{
    ...
    div.innerHTML = `
      ...
      <div class="detail-actions">
        <button class="tab-btn" type="button">Abrir detalle</button>
        <button class="share-btn" type="button">Compartir imagen</button>
      </div>
    `;
    const openBtn = div.querySelector(".tab-btn");
    const shareBtn = div.querySelector(".share-btn");
    if(openBtn) openBtn.addEventListener("click", ()=> openChequeInNewTab(div));
